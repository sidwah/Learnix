                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <span class="h3 text-dark"><?php echo number_format($stats['total_enrollments'] ?? 0); ?></span>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <span class="h3 text-dark"><?php echo number_format($stats['suspended_enrollments'] ?? 0); ?></span>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <span class="h3 text-dark"><?php echo number_format($stats['active_enrollments'] ?? 0); ?></span>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <span class="h3 text-dark"><?php echo number_format($stats['avg_completion'] ?? 0, 1); ?>%</span>
                            </div>
                            <div class="col-auto">
