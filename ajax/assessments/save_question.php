...
try {
    ...
    $access_check_query = "SELECT sq.section_id, cs.course_id, c.instructor_id 
    ...
    if ($question_id) {
        ...
        foreach ($variants as $variant) {
            ...
            $stmt->bind_param("ssissi", $question_text, $variant, $points, $explanation, $question_id, $section_quiz_id);
        ...
        foreach ($variants as $variant) {
            ...
            $stmt->bind_param("issisi", $section_quiz_id, $question_text, $variant, $points, $explanation, $next_order);
