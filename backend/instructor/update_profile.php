...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        switch ($action) {
            case 'personal_info':
                ...
                $notifMessage = 'Your personal information has been successfully updated.';
                break;
            ...
            case 'experience':
                ...
                $notifMessage = 'Your professional experience information has been successfully updated.';
                break;
            ...
            case 'social_links':
                ...
                $notifMessage = 'Your social links have been successfully updated.';
                break;
            ...
            case 'change_password':
                ...
                $notifMessage = 'Your account password has been successfully changed. If you did not make this change, contact support immediately.';
                break;
    ...
    // Only insert a notification if operation was successful and notifMessage is set
if (isset($notifMessage) && $response['status'] === 'success') {
    $notificationSql = "
    ...
    $notificationTitle = ucwords(str_replace('_', ' ', $action)) . " Updated"; // ✅ E.g., 'Personal Info Updated'
    $notificationType = ucwords(str_replace('_', ' ', $action)); // E.g., 'Personal Info', 'Change Password'

    $notificationStmt->bind_param("isss", $user_id, $notificationTitle, $notificationType, $notifMessage); // ✅ 4 fields
