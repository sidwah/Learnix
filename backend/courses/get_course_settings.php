<?php
// get_course_settings.php - Fetches settings for a course
...
try {
    ...
    $query = "
        ...
        LEFT JOIN 
            course_tag_mapping ctm ON c.course_id = ctm.course_id
        LEFT JOIN 
            tags t ON ctm.tag_id = t.tag_id
        WHERE 
            c.course_id = ?
        GROUP BY 
            c.course_id, cr.requirement_text
    ";
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        throw new Exception('Course settings not found.');
    }
