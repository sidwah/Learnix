...
<div class="navbar-sidebar-aside-content content-space-1 content-space-md-2 px-lg-5 px-xl-10">
    ...
    <div class="row mb-4">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card h-100">
                <div class="card-body">
                    <h6 class="card-subtitle mb-2">Banned Instructors</h6>
                    <div class="row align-items-center">
                        <div class="col">
            ...
            <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="sortable" data-sort="lastLogin">Last Login <span class="sort-icon">⇅</span></th>
                        <th>Actions</th>
                    </tr>
                </thead>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                function generateSampleData() {
                    ...
                    const names = ["John Smith", "Emily Johnson", "Michael Williams", "Sarah Brown", "David Jones",
                        "Jennifer Garcia", "Robert Martinez", "Jessica Robinson", "William Clark",
                        "Elizabeth Rodriguez", "Thomas Lewis", "Lisa Lee", "Joseph Walker", "Mary Hall",
                        "Charles Allen", "Patricia Young", "Christopher King", "Nancy Wright", "Daniel Scott",
                        "Margaret Green"
                    ];
                    ...
                    const specializations = [
                        ...
                        "Digital Marketing", "UI/UX Design", "Game Development", "Cybersecurity",
                        "Cloud Computing", "DevOps", "Artificial Intelligence", "Blockchain",
                        "JavaScript", "Python", "React", "Angular", "Node.js", "PHP", "Java", "C#"
                    ];
                    ...
                    for (let i = 0; i < 20; i++) {
                        ...
                        // Make most instructors active, with a few suspended or banned
                        let status;
                        if (i < 15) {
                            status = "active";
                        } else if (i < 18) {
                        ...
                        // Random verification status (70% chance of being verified)
                        const isVerified = Math.random() < 0.7;
                        
                        // Random course count (1-15)
                        const courseCount = Math.floor(Math.random() * 15) + 1;
                        
                        // Random student count (based on course count)
                        const studentCount = courseCount * (Math.floor(Math.random() * 50) + 10);
                        
                        // Random revenue
                        const revenue = studentCount * (Math.floor(Math.random() * 30) + 20);
                        
                        // Random last login (within the last 30 days)
                        const lastLogin = new Date();
                        lastLogin.setDate(lastLogin.getDate() - Math.floor(Math.random() * 30));
                        
                        // Random join date (1-3 years ago)
                        ...
                        // Random profile picture (30% chance of having one)
                        const hasProfilePic = Math.random() < 0.3;
                        
                        // Random instructor specializations (2-5)
                        const specCount = Math.floor(Math.random() * 4) + 2;
                        const instructorSpecs = [];
                        for (let j = 0; j < specCount; j++) {
                            const spec = specializations[Math.floor(Math.random() * specializations.length)];
                            if (!instructorSpecs.includes(spec)) {
                                instructorSpecs.push(spec);
                            }
                        }
                        ...
                        for (let j = 0; j < courseCount; j++) {
                            const courseTitle = [
                                "Complete Guide to " + instructorSpecs[j % instructorSpecs.length],
                                "Mastering " + instructorSpecs[j % instructorSpecs.length],
                                "Introduction to " + instructorSpecs[j % instructorSpecs.length],
                                "Advanced " + instructorSpecs[j % instructorSpecs.length],
                                instructorSpecs[j % instructorSpecs.length] + " Bootcamp"
                            ][Math.floor(Math.random() * 5)];
                            
                            const courseStudents = Math.floor(Math.random() * 100) + 10;
                            const courseRating = (Math.random() * 2 + 3).toFixed(1); // Rating between 3.0 and 5.0
                            const coursePrice = (Math.floor(Math.random() * 10) + 1) * 10; // Price between $10 and $100
                            const courseStatus = ["published", "draft", "published"][Math.floor(Math.random() * 3)];
                        ...
                        sampleData.push({
                            ...
                            location: ["New York, USA", "London, UK", "Sydney, Australia", "Toronto, Canada", "Berlin, Germany"][Math.floor(Math.random() * 5)],
                            status: status,
                            ...
                            lastLogin: lastLogin,
                            joinDate: joinDate,
                            profile_pic: hasProfilePic ? `instructor${i+1}.jpg` : null,
                            bio: `Experienced ${instructorSpecs[0]} instructor with a passion for teaching. I have been in the industry for ${Math.floor(Math.random() * 10) + 5} years and enjoy sharing my knowledge with students around the world.`,
                            specializations: instructorSpecs,
                            coursesList: courses,
                            statusReason: status !== "active" ? "Violation of community guidelines" : null
                        });
                    }
                ...
                function fetchInstructorData() {
                    ...
                    instructorData = generateSampleData();
                ...
                function displayInstructors() {
                    ...
                    paginatedInstructors.forEach(instructor => {
                        ...
                        if (instructor.status !== "banned") {
                            statusDropdown += `<a href="#" class="status-action change-status" data-id="${instructor.id}" data-status="banned">Ban Account</a>`;
                        }
                        ...
                        tableBody.innerHTML += `
                            <tr id="row-${instructor.id}">
                                ...
                                <td>${timeAgo(instructor.lastLogin)}</td>
                                <td>
                ...
                function viewInstructorDetails(instructorId) {
                    ...
                    document.getElementById("modalLastLogin").textContent = timeAgo(instructor.lastLogin);
