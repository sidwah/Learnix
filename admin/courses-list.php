        ...
        <form id="financialApprovalForm" action="../backend/admin/update-financial-approval.php" method="POST">
          <div class="modal-body">
            ...
            <div id="instructor-share-container" class="row mb-3">
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="instructorShare" class="form-label">Instructor's Revenue Share (% - whole numbers only)</label>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="platformShare" class="form-label">Platform's Revenue Share (%- whole numbers only)</label>
                  <div class="input-group">
