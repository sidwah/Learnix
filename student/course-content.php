        ...
        <div class="row">
                ...
                <div class="pe-lg-2">
                    <div class="mb-7">
                        <ul id="navbar" class="navbar-nav nav nav-vertical nav-tabs nav-tabs-borderless nav-sm">
                            ...
                            <?php foreach ($section_topics as $section_topic): ?>
            ...
            <div class="col-md-8 col-lg-9 column-divider-md">
                <div class="ps-lg-2">
                    <!-- Content Title -->
                    <div class="mb-2">
                        <h2><?php echo htmlspecialchars($topic['content_title']); ?></h2>
                    </div>
                    ...
                    <script>
                        // This script assumes your video player initialization is handled elsewhere
                        // If you need to manually initialize and add controls, you can use this:
                        // document.addEventListener('DOMContentLoaded', function() {
                        //     const playButton = document.querySelector('.js-inline-video-player');

                        //     playButton.addEventListener('click', function() {
                        //         const options = JSON.parse(this.getAttribute('data-hs-video-player-options'));
                        ...
                        //         videoElement.src = options.videoId + '.mp4'; // Assuming mp4 format
                        //         videoElement.controls = true; // Add controls
                        //         videoElement.autoplay = options.isAutoplay;
                        //         videoElement.className = 'w-100 h-100';

                        //         // Add alternative sources if needed
                        //         const sourceMP4 = document.createElement('source');
                        //         sourceMP4.src = options.videoId + '.mp4';
                        //         sourceMP4.type = 'video/mp4';
                        //         videoElement.appendChild(sourceMP4);

                        //         const sourceWebM = document.createElement('source');
                        //         sourceWebM.src = options.videoId + '.webm';
                        ...
                        //         // Hide the play button and preview image
                        //         this.style.display = 'none';
                        //         const previewImage = document.querySelector('.video-player-preview');
                    ...
                    <?php if (isset($topic['quiz_id']) && $topic['quiz_id']): ?>
                        <div class="card bg-soft-light border-0 mb-5">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <h5><i class="bi-clipboard-check me-2"></i> Quiz: <?php echo htmlspecialchars($topic['quiz_title'] ?? 'Topic Assessment'); ?></h5>
                                        <p class="mb-md-0">
                                            Test your knowledge with this quiz.
                                            <?php if ($topic['pass_mark']): ?>
                                                Pass mark: <span class="fw-bold text-success"><?php echo $topic['pass_mark']; ?>%</span>.
                                            <?php endif; ?>
                                            <?php if ($topic['time_limit']): ?>
                                                Time limit: <span class="fw-bold"><?php echo $topic['time_limit']; ?> minutes</span>.
                                            <?php endif; ?>
                                        </p>
                                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center border-top pt-4 mt-4">
                        ...
                        <?php else: ?>
                            <button class="btn btn-soft-secondary text-white" disabled>
                                <i class="bi-chevron-left me-1"></i> Previous Lesson
                            </button>
                        <?php endif; ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (saveNotesBtn && personalNotes) {
            ...
            function saveNotes(isAutoSave) {
                ...
                // Don't save if empty (unless clearing notes)
                if (!notesContent && isAutoSave) {
                    return;
                }
        ...
        if (printNotesBtn && personalNotes) {
            printNotesBtn.addEventListener('click', function() {
                const notesContent = personalNotes.value;
                const topicTitle = '<?php echo addslashes(htmlspecialchars($topic['content_title'])); ?>';
                const courseName = '<?php echo addslashes(htmlspecialchars($course_title)); ?>';
                ...
                printWindow.document.write(`
                    ...
                    <body>
                        ...
                        <div class="meta">
                            <p>Notes taken by: <?php echo htmlspecialchars($_SESSION['first_name'] . ' ' . $_SESSION['last_name']); ?></p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateProgressBars() {
            ...
            if (sectionProgressBar) {
                ...
                const sectionTopicsCount = <?php echo $section_progress['total_topics']; ?>;
                const newPercentage = Math.min(Math.ceil((<?php echo $section_progress['completed_topics']; ?> + 1) / sectionTopicsCount * 100), 100);
            ...
            if (courseProgressBar) {
                ...
                const courseTopicsCount = <?php echo $course_progress['total_topics']; ?>;
                const newPercentage = Math.min(Math.ceil((<?php echo $course_progress['completed_topics']; ?> + 1) / courseTopicsCount * 100), 100);
