...
// Use hardcoded sample notifications data instead of fetching from DB
$notifications = [
    [
        'notification_id' => 1,
        'title' => 'New Course Available',
        'message' => 'A new course has been added to your enrolled program.',
    ...
    [
        ...
        'message' => 'Don\'t forget about your project deadline next week.',
    ...
    [
        'notification_id' => 4,
        'title' => 'Live Session',
        'message' => 'A live Q&A session is scheduled for tomorrow at 3 PM.',
    ...
    [
        'notification_id' => 5,
        'title' => 'Course Update',
        'message' => 'One of your courses has been updated with new materials.',
...
<!-- ========== END HEADER ========== -->
            ...
            <?php if (count($notifications) > 0): ?>
                ...
                <div class="d-flex justify-content-between border-bottom p-3">
                    <div class="btn-group btn-group-sm" role="group">
                        <button type="button" class="btn btn-outline-primary active" id="showAllNotifs">All</button>
                        <button type="button" class="btn btn-outline-primary" id="showUnreadNotifs">Unread</button>
                    </div>
                    <a href="mark-all-notifications-read.php" class="btn btn-sm btn-ghost-secondary">
                ...
                <div class="notification-list">
                    <?php foreach ($notifications as $index => $notification): 
                        ...
                        // Define icon and background color based on notification type
                        switch (strtolower($notification['title'])) {
    ...
    <div id="floatingActionButton" class="position-fixed bottom-0 end-0 mb-4 me-4" style="z-index: 1030;">
        ...
        <ul class="dropdown-menu dropdown-menu-end p-2 mt-2 fade-in-up" style="min-width: 220px;">
            <li class="mb-2">
...
<!-- Add this JavaScript to handle notification interactions (place before closing body tag) -->
<script>
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.mark-read-btn').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            // For demo purposes we'll just simulate the UI update
            ...
            /*
            fetch('mark-notification-read.php?id=' + notificationId, {
                method: 'POST'
            })
    ...
    document.querySelectorAll('.delete-notification-btn').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            // Example AJAX call (uncomment and modify as needed)
            /*
            fetch('delete-notification.php?id=' + notificationId, {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
    ...
    const showAllBtn = document.getElementById('showAllNotifs');
    const showUnreadBtn = document.getElementById('showUnreadNotifs');
    ...
    function showEmptyState() {
        ...
        if (notificationList && filterBar && footerActions) {
