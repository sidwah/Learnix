...
<body class="navbar-sidebar-aside-lg">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
          ...
          const notificationSystem = {
            ...
            fetchNotifications: function(silent = false) {
              fetch('../ajax/department/fetch_department_notifications.php')
                ...
                if (mostRecent) {
                  this.showToast({
                    ...
                    message: totalUnread > 1 ?
                      `You have ${totalUnread} unread notifications including: "${mostRecent.title}"` : mostRecent.message,
    ...
    markNotificationRead: function(notificationId) {
        ...
        fetch('../ajax/department/mark_notification_read.php', {
            method: 'POST',
            body: formData
          })
          .then(response => response.json())
      ...
      deleteNotification: function(notificationId) {
        ...
        fetch('../ajax/department/delete_notification.php', {
            method: 'POST',
            body: formData
          })
          .then(response => response.json())
      ...
      markAllAsRead: function() {
        fetch('../ajax/department/mark_all_notifications_read.php', {
            method: 'POST'
          })
          .then(response => response.json())
          .then(data => {
