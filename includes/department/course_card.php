    ...
    <div class="col-md-3 course-card" 
        ...
        <div class="card h-100">
            ...
            <div class="card-body p-3">
                ...
                <?php if ($course['status'] === 'Draft' || $course['approval_status'] === 'revisions_requested'): ?>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <button type="button" class="btn btn-sm btn-ghost-secondary btn-icon rounded-pill" data-bs-toggle="dropdown">
