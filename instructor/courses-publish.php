...
<body class="loading" data-layout-color="light" data-leftbar-theme="dark" data-layout-mode="fluid" data-rightbar-onstart="true">
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                ...
                                <div class="btn-group mb-3 ms-1">
                                    <button type="button" class="btn btn-primary"><a href="courses-publish.php" class="text-white">Published</a></button>
            ...
            (SELECT COUNT(*) FROM course_sections cs WHERE cs.course_id = c.course_id) AS section_count
            FROM courses c 
            WHERE c.instructor_id = ? AND c.status='Published' ORDER BY c.updated_at DESC";
                            $stmt = $conn->prepare($sql);
