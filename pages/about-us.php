...
<main id="content" role="main">
    ...
    <!-- Gallery -->
    <div class="container container content-space-2">
        <!-- Heading -->
        <div class="w-lg-65 text-center mx-lg-auto mb-5 mb-md-9">
            <h1>Simplifying Education and Making Learning Accessible for Everyone.</h1>
        </div>
        <!-- End Heading -->
    ...
    <div class="container content-space-2 content-space-lg-3">
        ...
        <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
            ...
            <h2>Since its inception, Learnix has empowered learners and educators to thrive through innovation and accessibility.</h2>
        </div>
        <!-- End Heading -->
        ...
        <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
            ...
            <div class="flex-grow-1 ms-3">
                ...
                <p>We partner with top educators to design engaging and interactive courses that inspire a lifelong love of learning.</p>
            </div>
            </div>
            <!-- End Icon Blocks -->
        </div>
        ...
        <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
            ...
            <div class="flex-grow-1 ms-3">
                ...
                <p>Our platform helps you focus on what matters most: gaining skills and achieving your learning goals.</p>
            </div>
            </div>
            <!-- End Icon Blocks -->
        </div>
        ...
        <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
            ...
            <div class="flex-grow-1 ms-3">
                <h4>Effortless Learning Updates</h4>
                <p>Receive automatic updates on new lessons, modules, or assignments without lifting a finger—learning made seamless.</p>
            </div>
            </div>
            <!-- End Icon Blocks -->
        </div>
        ...
        <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
            ...
            <div class="flex-grow-1 ms-3">
                ...
                <p>Learnix balances functionality and user experience to provide a delightful and straightforward learning journey.</p>
            </div>
            </div>
            <!-- End Icon Blocks -->
        </div>
        ...
        <div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-0">
            ...
            <div class="flex-grow-1 ms-3">
                <h4>Empathy for Educators</h4>
                <p>We understand the needs of teachers, building tools that save time and maximize impact for over 10,000 educators worldwide.</p>
            </div>
            </div>
            <!-- End Icon Blocks -->
        </div>
        ...
        <div class="col-md-6 col-lg-5">
            ...
            <div class="flex-grow-1 ms-3">
                <h4>Stay curious</h4>
                <p>Explore new challenges and innovative methods with Learnix’s constantly evolving resources and experimental tools.</p>
            </div>
            </div>
            <!-- End Icon Blocks -->
        </div>
    ...
    <div class="container">
        ...
        <div class="col-lg-6 mb-3 mb-lg-0">
            ...
            <div class="card-body">
                <div class="w-65 pe-2">
                <h2 class="card-title text-white">Explore Our Courses</h2>
                <p class="card-text text-white">Discover a wide range of expertly crafted courses designed to boost your skills and knowledge in various fields.</p>
                <a class="btn btn-light btn-sm btn-transition" href="#">Browse Courses <i class="bi-chevron-right small ms-1"></i></a>
                </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="card-body">
                <div class="w-65 pe-2">
                <h2 class="card-title text-white">Flexible Learning</h2>
                <p class="card-text text-white">Learn at your own pace with flexible course schedules and on-demand resources accessible anytime, anywhere.</p>
    ...
    <div class="container content-space-2 content-space-lg-3">
        <!-- Heading -->
        <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
        <h2>Have questions about Learnix?</h2>
        <p class="lead">Find answers to some of the most frequently asked questions below.</p>
        </div>
        <!-- End Heading -->
        ...
        <div class="accordion accordion-flush accordion-lg" id="accordionFAQ">
            ...
            <div class="accordion-header" id="headingFAQOne">
                <a class="accordion-button" role="button" data-bs-toggle="collapse" data-bs-target="#collapseFAQOne" aria-expanded="true" aria-controls="collapseFAQOne">
                What payment methods are available on Learnix?
                </a>
            </div>
            <div id="collapseFAQOne" class="accordion-collapse collapse show" aria-labelledby="headingFAQOne" data-bs-parent="#accordionFAQ">
                ...
                Learnix accepts payments via major credit and debit cards, mobile money platforms, and supported digital wallets through secure payment gateways. Unfortunately, we currently do not support cryptocurrency payments or direct bank transfers.
                </div>
            </div>
            </div>
            <!-- End Accordion Item -->
            ...
            <div class="accordion-header" id="headingFAQTwo">
                <a class="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#collapseFAQTwo" aria-expanded="false" aria-controls="collapseFAQTwo">
            ...
            <div id="collapseFAQTwo" class="accordion-collapse collapse" aria-labelledby="headingFAQTwo" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                Refunds are available under specific conditions as outlined in our <a href="#">Refund Policy</a>. If you meet these criteria, please contact us within 14 days of your purchase at <a href="mailto:billing@learnix.com">billing@learnix.com</a>. Our team will review your request and assist you further.
                </div>
            </div>
            </div>
            <!-- End Accordion Item -->
            ...
            <div class="accordion-header" id="headingFAQThree">
                <a class="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#collapseFAQThree" aria-expanded="false" aria-controls="collapseFAQThree">
            ...
            <div id="collapseFAQThree" class="accordion-collapse collapse" aria-labelledby="headingFAQThree" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                A receipt will be automatically sent to your registered email address immediately after your payment. If you need a duplicate or encounter any issues, please reach out to us at <a href="mailto:billing@learnix.com">billing@learnix.com</a>.
                </div>
            </div>
            </div>
            <!-- End Accordion Item -->
            ...
            <!-- Accordion Item -->
            <div class="accordion-item">
            <div class="accordion-header" id="headingFAQFour">
                <a class="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#collapseFAQFour" aria-expanded="false" aria-controls="collapseFAQFour">
                How do I select the best course for me?
                </a>
            </div>
            <div id="collapseFAQFour" class="accordion-collapse collapse" aria-labelledby="headingFAQFour" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                Learnix provides detailed course descriptions, previews, and learner reviews to guide you in making an informed choice. You can also filter courses by category, difficulty level, or popularity. If you’re still unsure, feel free to email us at <a href="mailto:support@learnix.com">support@learnix.com</a>, and our team will assist you in selecting the best course for your needs.
                </div>
            </div>
            </div>
            <!-- End Accordion Item -->
            ...
            <!-- Accordion Item -->
            <div class="accordion-item">
            <div class="accordion-header" id="headingFAQFive">
                <a class="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#collapseFAQFive" aria-expanded="false" aria-controls="collapseFAQFive">
                What support is available for technical issues?
                </a>
            </div>
            <div id="collapseFAQFive" class="accordion-collapse collapse" aria-labelledby="headingFAQFive" data-bs-parent="#accordionFAQ">
                <div class="accordion-body">
                Our support team is available to help you resolve any technical issues you might face on the platform. You can reach us via the <a href="/help-center">Help Center</a> or email us at <a href="mailto:support@learnix.com">support@learnix.com</a>. We aim to respond to all inquiries within 24 hours.
                </div>
            </div>
            </div>
            <!-- End Accordion Item -->
